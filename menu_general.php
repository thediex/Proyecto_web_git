		...
		<div class='row'>
			...
			<div class='row column log-in-form'>
				...
				<form action='consulta_activo.php' method='post'>
						<p><input type='submit' class='button expanded' value='Realizar Consulta General'></p>
						
				</form>
				<form action='menu_inventario.php' method='post'>
						<p><input type='submit' class='button expanded' value='Validar Inventario'></p>					  
				</form>
				<form action='consulta_inventario_traslado.php' method='post'>
						<p><input type='submit' class='button expanded' value='Traslado Inventario Propio'></p>					  
				</form>
				<form action='valida_inventario_traslado.php' method='post'>
						<p><input type='submit' class='button expanded' value='Aceptar Traslados'></p>
				</form>
